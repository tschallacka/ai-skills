...
planning skill revision current.

Your current working directory is /tmp/reviewer-oracle-hardening-current-complete/current/workspace. Treat this directory as your
...
```text
/tmp/ai-skills-capsules/20260811T145902Z-hardening-current-complete/current/worker/basic-test-proof-plan.md
/tmp/ai-skills-capsules/20260811T145902Z-hardening-current-complete/current/worker/planning/SKILL.md
```

Read `benchmark-test.md`, `task-spec.md`, the task specification in
`/tmp/ai-skills-capsules/20260811T145902Z-hardening-current-complete/current/worker/basic-test-proof-plan.md`, and the repository-local planning
skill in full. When `planning/SKILL.md` names another reference, resolve that
path relative to `/tmp/ai-skills-capsules/20260811T145902Z-hardening-current-complete/current/worker/planning/` and read the resolved
...
```text
basic-test-proof-current-20260811T145902Z-hardening-current-complete-isolated-plan
```
...
approval artifacts. Each finding must use a stable `AR-NN` ID and include the
repository-relative path and precise location, the observed contradiction or
impact, evidence, and required correction. Consolidated findings covering
multiple defects are valid; do not invent hidden seed IDs or mutation text.
...
```bash
validator="/tmp/ai-skills-capsules/20260811T145902Z-hardening-current-complete/current/worker/planning/scripts/validate-plan.sh"
plan_dir="basic-test-proof-current-20260811T145902Z-hardening-current-complete-isolated-plan"
if [ -d ".plans/basic-test-proof-current-20260811T145902Z-hardening-current-complete-isolated-plan" ]; then
  plan_dir=".plans/basic-test-proof-current-20260811T145902Z-hardening-current-complete-isolated-plan"
fi
set +e
