Analyze the completed planning benchmark batch `20260810T205301Z-pilot-142-final`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260810T205301Z-pilot-142-final/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260810T205301Z-pilot-142-final/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260810T205301Z-pilot-142-final/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260810T205301Z-pilot-142-final/analysis/results/comparison.md
```
