...
Your current working directory is /tmp/20260810T205301Z-pilot-142-final/1.4.1/workspace. Treat this directory as your
...
```text
/tmp/ai-skills-capsules/20260810T205301Z-pilot-142-final/1.4.1/worker/basic-test-proof-plan.md
/tmp/ai-skills-capsules/20260810T205301Z-pilot-142-final/1.4.1/worker/planning/SKILL.md
```

Read `benchmark-test.md`, `task-spec.md`, the task specification in
`/tmp/ai-skills-capsules/20260810T205301Z-pilot-142-final/1.4.1/worker/basic-test-proof-plan.md`, and the repository-local planning
skill in full. When `planning/SKILL.md` names another reference, resolve that
path relative to `/tmp/ai-skills-capsules/20260810T205301Z-pilot-142-final/1.4.1/worker/planning/` and read the resolved
...
```text
basic-test-proof-1.4.1-20260810T205301Z-pilot-142-final-isolated-plan
```
...
```bash
validator="/tmp/ai-skills-capsules/20260810T205301Z-pilot-142-final/1.4.1/worker/planning/scripts/validate-plan.sh"
plan_dir="basic-test-proof-1.4.1-20260810T205301Z-pilot-142-final-isolated-plan"
if [ -d ".plans/basic-test-proof-1.4.1-20260810T205301Z-pilot-142-final-isolated-plan" ]; then
  plan_dir=".plans/basic-test-proof-1.4.1-20260810T205301Z-pilot-142-final-isolated-plan"
fi
set +e
