Analyze the completed planning benchmark batch `20260810T210953Z-pilot-142-control`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260810T210953Z-pilot-142-control/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260810T210953Z-pilot-142-control/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260810T210953Z-pilot-142-control/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260810T210953Z-pilot-142-control/analysis/results/comparison.md
```
