...
Your current working directory is /tmp/20260811T053701Z-pilot-142-matrix-iterative/1.3.1/workspace. Treat this directory as your
...
`/tmp/ai-skills-capsules/20260811T053701Z-pilot-142-matrix-iterative/1.3.1/worker/basic-test-proof-plan.md`, and the repository-local planning
skill in full. When `planning/SKILL.md` names another reference, resolve that
path relative to `/tmp/ai-skills-capsules/20260811T053701Z-pilot-142-matrix-iterative/1.3.1/worker/planning/` and read the resolved
...
```text
basic-test-proof-1.3.1-20260811T053701Z-pilot-142-matrix-iterative-isolated-plan
```
...
```bash
validator="/tmp/ai-skills-capsules/20260811T053701Z-pilot-142-matrix-iterative/1.3.1/worker/planning/scripts/validate-plan.sh"
plan_dir="basic-test-proof-1.3.1-20260811T053701Z-pilot-142-matrix-iterative-isolated-plan"
if [ -d ".plans/basic-test-proof-1.3.1-20260811T053701Z-pilot-142-matrix-iterative-isolated-plan" ]; then
  plan_dir=".plans/basic-test-proof-1.3.1-20260811T053701Z-pilot-142-matrix-iterative-isolated-plan"
fi
set +e
