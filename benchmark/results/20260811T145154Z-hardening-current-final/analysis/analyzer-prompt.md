Analyze the completed planning benchmark batch `20260811T145154Z-hardening-current-final`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T145154Z-hardening-current-final/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T145154Z-hardening-current-final/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260811T145154Z-hardening-current-final/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260811T145154Z-hardening-current-final/analysis/results/comparison.md
```
