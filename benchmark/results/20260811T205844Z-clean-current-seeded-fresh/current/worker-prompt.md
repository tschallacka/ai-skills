...
Your current working directory is /tmp/20260811T205844Z-clean-current-seeded-fresh/current/workspace. Treat this directory as your
...
`/tmp/ai-skills-capsules/20260811T205844Z-clean-current-seeded-fresh/current/worker/basic-test-proof-plan.md`, and the repository-local planning
skill in full. When `planning/SKILL.md` names another reference, resolve that
path relative to `/tmp/ai-skills-capsules/20260811T205844Z-clean-current-seeded-fresh/current/worker/planning/` and read the resolved
...
```text
basic-test-proof-current-20260811T205844Z-clean-current-seeded-fresh-isolated-plan
```
...
```bash
validator="/tmp/ai-skills-capsules/20260811T205844Z-clean-current-seeded-fresh/current/worker/planning/scripts/validate-plan.sh"
plan_dir="basic-test-proof-current-20260811T205844Z-clean-current-seeded-fresh-isolated-plan"
if [ -d ".plans/basic-test-proof-current-20260811T205844Z-clean-current-seeded-fresh-isolated-plan" ]; then
  plan_dir=".plans/basic-test-proof-current-20260811T205844Z-clean-current-seeded-fresh-isolated-plan"
fi
set +e
