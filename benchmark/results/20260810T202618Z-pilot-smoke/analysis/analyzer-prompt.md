Analyze the completed planning benchmark batch `20260810T202618Z-pilot-smoke`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260810T202618Z-pilot-smoke/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260810T202618Z-pilot-smoke/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260810T202618Z-pilot-smoke/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260810T202618Z-pilot-smoke/analysis/results/comparison.md
```
