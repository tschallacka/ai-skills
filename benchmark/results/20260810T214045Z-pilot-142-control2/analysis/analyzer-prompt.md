Analyze the completed planning benchmark batch `20260810T214045Z-pilot-142-control2`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260810T214045Z-pilot-142-control2/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260810T214045Z-pilot-142-control2/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260810T214045Z-pilot-142-control2/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260810T214045Z-pilot-142-control2/analysis/results/comparison.md
```
