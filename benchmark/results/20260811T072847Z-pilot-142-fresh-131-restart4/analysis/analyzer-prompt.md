Analyze the completed planning benchmark batch `20260811T072847Z-pilot-142-fresh-131-restart4`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T072847Z-pilot-142-fresh-131-restart4/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T072847Z-pilot-142-fresh-131-restart4/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260811T072847Z-pilot-142-fresh-131-restart4/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260811T072847Z-pilot-142-fresh-131-restart4/analysis/results/comparison.md
```
