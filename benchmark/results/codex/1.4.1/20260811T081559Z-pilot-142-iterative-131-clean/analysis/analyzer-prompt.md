Analyze the completed planning benchmark batch `20260811T081559Z-pilot-142-iterative-131-clean`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T081559Z-pilot-142-iterative-131-clean/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T081559Z-pilot-142-iterative-131-clean/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260811T081559Z-pilot-142-iterative-131-clean/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260811T081559Z-pilot-142-iterative-131-clean/analysis/results/comparison.md
```
