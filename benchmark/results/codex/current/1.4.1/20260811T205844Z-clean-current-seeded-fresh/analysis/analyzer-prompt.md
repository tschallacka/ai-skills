Analyze the completed planning benchmark batch `20260811T205844Z-clean-current-seeded-fresh`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T205844Z-clean-current-seeded-fresh/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T205844Z-clean-current-seeded-fresh/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260811T205844Z-clean-current-seeded-fresh/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260811T205844Z-clean-current-seeded-fresh/analysis/results/comparison.md
```
