Analyze the completed planning benchmark batch `20260811T145902Z-hardening-current-complete`.

You may inspect only:

- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T145902Z-hardening-current-complete/analysis/benchmark-test.md`
- `/home/mdibbets/git/ai-skills/benchmark/results/20260811T145902Z-hardening-current-complete/analysis/harness-summary.tsv`
- result archives under `/tmp/ai-skills-capsules/20260811T145902Z-hardening-current-complete/analysis/results` for this run

Write the comparison report to:

```text
/tmp/ai-skills-capsules/20260811T145902Z-hardening-current-complete/analysis/results/comparison.md
```
