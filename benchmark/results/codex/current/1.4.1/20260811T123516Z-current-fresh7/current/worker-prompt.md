...
Your current working directory is /tmp/current-fresh7/current/workspace. Treat this directory as your
...
```text
/tmp/ai-skills-capsules/20260811T123516Z-current-fresh7/current/worker/basic-test-proof-plan.md
/tmp/ai-skills-capsules/20260811T123516Z-current-fresh7/current/worker/planning/SKILL.md
```

Read `benchmark-test.md`, `task-spec.md`, the task specification in
`/tmp/ai-skills-capsules/20260811T123516Z-current-fresh7/current/worker/basic-test-proof-plan.md`, and the repository-local planning
skill in full. When `planning/SKILL.md` names another reference, resolve that
path relative to `/tmp/ai-skills-capsules/20260811T123516Z-current-fresh7/current/worker/planning/` and read the resolved
...
```text
basic-test-proof-current-20260811T123516Z-current-fresh7-isolated-plan
```
...
```bash
validator="/tmp/ai-skills-capsules/20260811T123516Z-current-fresh7/current/worker/planning/scripts/validate-plan.sh"
plan_dir="basic-test-proof-current-20260811T123516Z-current-fresh7-isolated-plan"
if [ -d ".plans/basic-test-proof-current-20260811T123516Z-current-fresh7-isolated-plan" ]; then
  plan_dir=".plans/basic-test-proof-current-20260811T123516Z-current-fresh7-isolated-plan"
fi
set +e
