...
§ 7.2
The captured baseline of all 59 test outputs and exit statuses is the acceptance evidence: any difference beyond mktemp paths is a regression.
...
- UI affected: no
- Rationale: No user-facing surface changes: the work touches helper argument parsing and test reporting only.
