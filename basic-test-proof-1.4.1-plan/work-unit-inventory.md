...
| W06 | docs | `1.4.1-analyze.md` | `execution report` | `N/A` | Record revision, timestamps, elapsed seconds, worker result, validator/review findings, no-artifact/process result, and token-cost evidence or explicit unavailability. | W05 | 02-plan-proof-and-handoff | 04-step-report |
